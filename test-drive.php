                  ...
                  <div class="gray-form row">
                     <div class="col-lg-12 col-md-12">
                        ...
                        <form name="form" class="form-horizontal" id="contactform" role="form" >
                           <h5>Escolha o dia e o horário</h5>
                           <p>Quer sentir o prazer de se aventurar no novo T4? Preencha os formulários abaixo que entraremos em contato com você.</p>
                           <div class="contact-form">
                              <div class="form-group">
                              	<span>Nome Completo*</span>
                                 <input ng-model="dados.LE_Nome" ng-required="true" ng-disabled="load" id="name" type="text" placeholder="" class="form-control"  name="name">
                              </div>
                              <div class="form-group">
                              	<span>E-mail*</span>
                                 <input ng-model="dados.LE_Email" ng-required="true" ng-disabled="load" type="email" placeholder="" class="form-control" name="email">
                              </div>
                              <div class="form-group">
                              	<span>Telefone*</span>
                                 <input ng-model="dados.LE_Telefone" ng-required="true" ng-disabled="load" type="text" placeholder="" class="form-control" name="phone">
                              </div>
                              <div class="form-group">
                              	<span>Cidade*</span>
                                 <input ng-model="dados.tmp.LE_Cidade" ng-required="true" ng-disabled="load" id="name" type="text" placeholder="" class="form-control"  >
                              </div>
                              <div class="form-group">
                              	<span>Melhor Data* </span>
                                 <input ng-model="dados.tmp.LE_MelhorData" ng-required="true" ng-disabled="load" placeholder="" class="form-control" >
                              </div>
                              <div class="form-group">
                              	<span>Melhor horário* (08h - 17h)</span>
                                 <input ng-model="dados.tmp.LE_MelhorHora" ng-required="true" ng-disabled="load"  placeholder="" class="form-control"  >
                              </div>
	   ...
	   <script type="text/javascript">
	      ...
	      .controller('Lead', function($scope, $log, $http, $location, ngDialog, $httpParamSerializerJQLike){
	          ...
	          $scope.enviarLead = function(dados, tmp = null) {
	            ...
	            dados.LE_Descricao = "Cidade: "+dados.tmp.LE_Cidade+"\n Melhor Data: "+dados.tmp.LE_MelhorData+"\n Melhor Hora: "+dados.tmp.LE_MelhorHora;
	            delete dados.tmp;
